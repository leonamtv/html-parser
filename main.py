...
<head>
  ...
  <base href="https://leonamtv.github.io/leonamtv/">  <meta name="viewport" content="width=device-width, initial-scale=1">
...
#     string += 'A '
#   if isinstance(token, TokenFechamento) :
#     string += 'F '
#   print(string + token.nome)
